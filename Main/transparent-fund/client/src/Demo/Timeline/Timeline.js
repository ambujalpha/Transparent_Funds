        ...
        <Aux>
            <Row>
                                ...
                                <Col md={12}>
                                    <Form>
                                        <Form.Group>
                                            ...
                                            <Form.Control value={memberName} onChange={(e)=>{setMemberName(e.target.value)}} type="text" placeholder="Enter Member Name" />
                                        </Form.Group>
                                        <Form.Group>
                                            <Form.Label>Member Address</Form.Label>
                                            <Form.Control value={memberAddress} onChange={(e)=>{setMemberAddress(e.target.value)}} type="text" placeholder="Enter your address" />
                                        </Form.Group>
                                        <Form.Group>
                                            <Form.Label>Member Designation</Form.Label>
                                            <Form.Control value={memberDesignation} onChange={(e)=>{setMemberDesignation(e.target.value)}} type="text" placeholder="Enter your designation" />
                                        </Form.Group>
                                        
                                        <Button onClick={createCommitteeHandler}  variant="primary" >
                                            Submit
                                        </Button>
                                    </Form>
                                </Col>
                    ...
                    <Card className='card-event'>
                        <Card.Body>
                            <div className="row align-items-center justify-content-center">
                                <div className="col">
                                    <h5 className="m-0">Total Contracts</h5>
                                </div>
                        ...
                        <Card.Body className='border-bottom'>
                            <div className="row d-flex align-items-center">
                                ...
                                <div className="col">
                                    ...
                                    <span className="d-block text-uppercase">Contracts Registered</span>
                                </div>
                            </div>
                        </Card.Body>{/*
                        <Card.Body>
                    ...
                    <Card className='card-social'>
                        ...
                        <Card.Body>
                            <div className="row align-items-center justify-content-center card-active">
                                <div className="col-6">
                                    <h6 className="text-center m-b-10"><span className="text-muted m-r-5">Donated:</span>800000</h6>
                                ...
                                <div className="col-6">
                                    <h6 className="text-center  m-b-10"><span className="text-muted m-r-5">Remaining :</span>1600000</h6>
                                    <div className="progress">
                ...
                <Col md={6} xl={4}>
                    <Card className='card-social'>
                        <Card.Body className='border-bottom'>
                            <div className="row align-items-center justify-content-center">
                                <div className="col-auto">
                                    <h6>Donate for Books</h6>
                                </div>
                                <div className="col text-right">
                                    <h3>500000</h3>
                                    <h5><span className="text-muted">55 People Donated</span></h5>
                                </div>
                            </div>
                        </Card.Body>
                        <Card.Body>
                            <div className="row align-items-center justify-content-center card-active">
                                <div className="col-6">
                                    <h6 className="text-center m-b-10"><span className="text-muted m-r-5">Donated:</span>100000</h6>
                                    <div className="progress">
                                ...
                                <div className="col-6">
                                    <h6 className="text-center  m-b-10"><span className="text-muted m-r-5">Remaining:</span>100000</h6>
                                    <div className="progress">
                ...
                <Col md={6} xl={4}>
                    <Card>
                        <Card.Header>
                            <Card.Title as='h5'>Progress Bar</Card.Title>
                        </Card.Header>
                        <Card.Body>
                            ...
                            <div className="row">
                                <div className="col-xl-12">
                                    <h6 className="align-items-center float-left">Fire Alarm System</h6>
                                ...
                                <div className="col-xl-12">
                                    <h6 className="align-items-center float-left">Water System</h6>
                                ...
                                <div className="col-xl-12">
                                    <h6 className="align-items-center float-left">Basic Construction</h6>
                                ...
                                <div className="col-xl-12">
                                    <h6 className="align-items-center float-left">Wooden Work</h6>
                                ...
                                <div className="col-xl-12">
                                    <h6 className="align-items-center float-left">Electricity Work</h6>
                ...
                <Col md={6} xl={8} className='m-b-30'>
                    <h3><span className="text-muted">Transactions</span></h3>
